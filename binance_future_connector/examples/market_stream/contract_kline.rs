use binance_future_connector::{
    market::{contract_klines::ContractType, klines::KlineInterval}, market_stream::contract_kline::ContractKlineStream,
...
fn main() {
    ...
    conn.subscribe(vec![
        &ContractKlineStream::new("BTCUSDT", ContractType::Perpetual, KlineInterval::Minutes1).into(),
    ]);
    // Read messages
