...
//!
//! ```
//! use binance_spot_connector::ureq::BinanceHttpClient;
//!
//! let testnet_http_client = BinanceHttpClient::with_url("https://testnet.binance.vision");
//! ```
//!
//! ```no_run
//! use binance_spot_connector::tungstenite::BinanceWebSocketClient;
//!
...
//!
//! ```no_run
//! use binance_spot_connector::{market, ureq::BinanceHttpClient};
...
//! Generated logs.
//! ```ignore
//! [2022-01-01T00:00:01Z INFO  binance_spot_connector::ureq::client] https://api.binance.com/api/v3/avgPrice?symbol=BNBUSDT
//! [2022-01-01T00:00:01Z INFO  binance_spot_connector::ureq::client] 200
...
//!
//! ```ignore
//! builder.filter(Some("binance_spot_connector"), log::LevelFilter::Off)
//! ```
//!
//! # Errors
//!
